...
class GCNPolicy(K.Model):
	...
	def __init__(self, embSize, nConsF, nEdgeF, nVarF, isGraphLevel = False):
		super().__init__()
	...
	def call(self, inputs, training):
		...
		# EMBEDDINGS
		constraint_features = tf.where(tf.math.is_inf(constraint_features), tf.zeros_like(constraint_features), constraint_features)
		variable_features = tf.where(tf.math.is_inf(variable_features), tf.zeros_like(variable_features), variable_features)
		#print("Before constraint_features", constraint_features.shape)
		constraint_features = self.cons_embedding(constraint_features)
		#print("After constraint_features", constraint_features.shape)
		#print("Before edge_features", edge_features.shape)
		edge_features = self.edge_embedding(edge_features)
		#print("After edge_features", edge_features.shape)
		#print("Before variable_features", variable_features.shape)
		variable_features = self.var_embedding(variable_features)
		#print("After variable_features", variable_features.shape)
