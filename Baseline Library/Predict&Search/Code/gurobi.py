...
from ACP_for_PandS import run_ACP
...
def collect(ins_dir,q,sol_dir,log_dir,bg_dir,settings):
    ...
    while True:
        ...
        # sol_data = run_ACP(filepath, settings)
...
if __name__ == '__main__':
    ...
    # miplib_mixed_neos, miplib_mixed_supportcase, Nexp, Transportations
    ...
    parser.add_argument('--maxTime', type=int, default=4000)
