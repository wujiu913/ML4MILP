...
if __name__ == '__main__':
    ...
    ### SET-UP DATASET ###
    train_files = list(pathlib.Path(f"data/samples/{args.problem}/train/").glob('sample_*.pkl'))
    valid_files = list(pathlib.Path(f"data/samples/{args.problem}/valid/").glob('sample_*.pkl'))
