...
if __name__ == "__main__":
    ...
    try:
        ...
        train_files = list(pathlib.Path(f"{args.data_path}/{args.problem}/train").glob('sample_*.pkl'))
        valid_files = list(pathlib.Path(f"{args.data_path}/{args.problem}/valid").glob('sample_*.pkl'))
    ...
    if (
        ...
        teacher.restore_state(f'/home/sharing/disk3/chengyaoyang_sd3/_deposit/_l2b_benchmark/model/{args.problem}/0/train_params.pkl')
        teacher.to(device)
        teacher.eval()
